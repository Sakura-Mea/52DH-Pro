<div class="col-sm-3 col-md-3 col-lg-2">
    ...
    <div class="sidebar hidden-xs">
        ...
        <div class="panel panel-default sidebar-footer">
            <div class="list-group">
                <div class="list-group-item text-center bg-success"><a target="_blank" href="https://www.munsea.com">山海数据</a></div>
            </div>
            <div class="list-group">
                <div class="list-group-item text-center bg-success"><a target="_blank" href="https://xpay.233m.com">梦之付Pro</a></div>
            </div>
        </div>
    </div>
</div>
